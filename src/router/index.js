    ...
    routes: [
        ...
        },
        {
            ...
            children: [
                ...
                {
                    path: '/pageTable',
                    component: () => import(/* webpackChunkName: "table" */ '../components/page/demo/pageTable.vue'),
                    meta: { title: '分页表格' }
                },
                {
                    path: '/tabs',
                ...
                },
                {
                    // 拖拽列表组件
                    path: '/drag',
                    component: () => import(/* webpackChunkName: "drag" */ '../components/page/demo/DragList.vue'),
                    meta: { title: '拖拽列表' }
                },
                {
                    // 拖拽Dialog组件
                    path: '/dialog',
                    component: () => import(/* webpackChunkName: "dragdialog" */ '../components/page/demo/DragDialog.vue'),
                    meta: { title: '拖拽弹框' }
                },
                {
                    // 国际化组件
                ...
                {
                    path: '/404',
                    component: () => import(/* webpackChunkName: "404" */ '../components/page/demo/404.vue'),
                    meta: { title: '404' }
                },
                {
                    path: '/403',
                    component: () => import(/* webpackChunkName: "403" */ '../components/page/demo/403.vue'),
                    meta: { title: '403' }
                },
            ]
        },
        {
            path: '/login',
            component: () => import(/* webpackChunkName: "login" */ '../components/page/demo/Login.vue'),
            meta: { title: '登录' }
        },
        {
            path: '*',
